...
Концепцию тестирования с использованием двойников (Test Doubles), которая была введена Джерардом Месарошом (Gerard Meszaros), можно описать следующим образом.
